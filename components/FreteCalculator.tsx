...
interface CalculoFreteProps {
    onSelectFrete?: (valorFrete: number) => void; // callback para enviar o valor escolhido
    ...
    return (
        <div className="max-w-xl mx-auto p-6">
            ...
            <div className="space-y-4">
              ...
              ${freteSelecionado === valor ? "border-red-600 bg-red-900/30" : "border-gray-700 hover:border-red-600"}`}
                        >
